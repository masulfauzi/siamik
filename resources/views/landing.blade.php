...
<html lang="en">
    <head>
        ...
        <meta name="description" content="SIAMIK - Sistem Informasi Akademik. Adalah aplikasi yang digunakan untuk membantu mengelola sekolah, mulai dari data guru, data siswa, jurnal mengajar dll." />
