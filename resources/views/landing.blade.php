...
<html lang="en">
    <head>
        ...
        <meta name="description" content="SIAMIK - Sistem Informasi Akademik. Adalah aplikasi yang digunakan untuk membantu mengelola sekolah, mulai dari data guru, data siswa, jurnal mengajar dan lain-lain." />
        <meta name="author" content="" />
        <title>SIAMIK - Sistem Informasi Akademik</title>
                ...
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-transparent navbar-dark fixed-top">
                        <div class="container px-5">
                            <a class="navbar-brand text-white" href="{{ url('') }}">SIAMIK</a>
                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><i data-feather="menu"></i></button>
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ms-auto me-lg-5">
                                    <li class="nav-item"><a class="nav-link" href="{{ url('') }}">Home</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ url('') }}">Keunggulan</a></li>
                            ...
                            <div class="container px-5">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-6" data-aos="fade-up">
                                        <h1 class="page-header-ui-title">Sistem Informasi Akademik</h1>
                                        <p class="page-header-ui-text mb-5">Miliki Sistem Informasi Akademik untuk sekolah anda tanpa ribet. Cukup klik registrasi dan nikmati semua fiturnya.</p>
                        ...
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center justify-content-center">
                                ...
                                <div class="col-lg-6 order-0 order-lg-1 mb-5 mb-lg-0" data-aos="fade-left">
                                    <div class="mb-5">
                                        <h2>Apa Keunggulan Siamik?</h2>
                                        <p class="lead">Siamik dikembangkan untuk membantu pengelolaan sekolah dengan <b>mudah</b>, dan <b>gratis!</b></p>
                                    </div>
                                    <div class="row gx-5">
                                        <div class="col-md-6 mb-4">
                                            <h6>Tidak Perlu Install</h6>
                                            <p class="mb-2 small">Cukup melakukan registrasi dan anda bisa menikmati semua fitur.</p>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <h6>Support 24/7</h6>
                                            <p class="mb-2 small mb-0">Kami akan membantu anda kapanpun, agar pengelolaan sekolah lancar.</p>
                                            {{-- <a class="small text-arrow-icon" href="#!">
                                                Learn More
                                                <i data-feather="arrow-right"></i>
                                            </a> --}}
                                    ...
                                    <div class="row gx-5">
                                        <div class="col-md-6 mb-4">
                                            <h6>Cepat & Reliable</h6>
                                            <p class="mb-2 small mb-0">Dikembangkan berdasarkan pengalaman dalam mengelola seklah.</p>
                                            {{-- <a class="small text-arrow-icon" href="#!">
                                                Learn More
                                                <i data-feather="arrow-right"></i>
                                            </a> --}}
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <h6>Gratis</h6>
                                            <p class="small mb-0">Nikmati semua fitur dalam aplikasi ini secara <b>gratis!</b></p>
                                            {{-- <a class="small text-arrow-icon" href="#!">
                                                Learn More
                                                <i data-feather="arrow-right"></i>
                                            </a> --}}
                        ...
                        <div class="container px-5">
                            ...
                            <div class="row gx-5 justify-content-center text-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="text-white">Bergabung dengan kami.</h2>
                                    <p class="lead text-white-50 mb-5">Nikmati fitur yang kami sediakan dengan klik tombol dibawah ini!</p>
                                    <a class="btn btn-teal fw-500" href="#!">Daftar Sekarang!</a>
                                </div>
                            </div>
                        </div>
                        <div class="svg-border-rounded text-white">
                        ...
                        <div class="container px-5 mt-5">
                            <div class="row gx-5 align-items-center">
                                ...
                                <div class="col-lg-6 text-lg-end">
                                    <a target="_blank" class="btn btn-primary fw-500 me-3 my-2" href="https://wa.me/6285727230168?text=Halo, saya ingin mendaftar siamik.">Contact Sales</a>
            ...
            <div id="layoutDefault_footer">
                <footer class="footer pt-10 pb-5 mt-auto bg-light footer-light">
                    <div class="container px-5">
                        ...
                        <hr class="my-5" />
                        <div class="row gx-5 align-items-center">
                            <div class="col-md-6 small">Copyright © SIAMIK 2023</div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"80dbb24c5a906c00","token":"6e2c2575ac8f44ed824cef7899ba8463","version":"2023.8.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>
